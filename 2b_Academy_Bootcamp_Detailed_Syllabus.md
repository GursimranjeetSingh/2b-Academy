...
**Total Duration:** 22 training days, 5 days/week (Mon–Fri) | **3 hours/day** | **66 contact hours**
*(Assumption: Mon–Fri working week. If your institute runs Tue–Sat or includes Saturdays, tell me and I'll re-map the dates — the day-by-day content underneath doesn't change, only the calendar labels do.)*
...
| Time | What happens |
|---|---|
| 0–8 min | **Hook.** Recap yesterday in 2 minutes via rapid-fire Q&A ("one word — what's a variable?"), then a 1-line real-world story for today's topic ("Netflix's recommendation engine literally starts with the loop you're about to learn"). On Day 1 of a new module, this slot becomes a 5–10 min recap quiz of the previous module instead. |
...
| 45–55 min | Recap on whiteboard/slide: 3 bullet takeaways. Preview tomorrow with a 1-line teaser/cliffhanger. |
| 55–60 min | **Exit ticket** — each student writes one sentence: "today I learned ___" or one remaining doubt. You read these before the next class to plan re-teaching. |
...
- **Activity:** everyone writes and runs `print("Hello, my name is ___")`.
